    ...
    while True:
        try:
            ...
            if user_choice not in range(1, 4):
                ...
                game_score(user_guess, user_choice, computer_guess, computer_choice, player_score, comp_score)
        except ValueError:
            print("Please enter a valid number")
  
     
def game_score(user_guess, user_choice, computer_guess, computer_choice, player_score, comp_score):
    """
    compare score
    """      
